...
-------------------------------------------
- Supports CleverTap Android SDK [v4.6.2](https://github.com/CleverTap/clevertap-android-sdk/blob/corev4.6.2_ptv1.0.5/CHANGELOG.md) and associated enhancements
